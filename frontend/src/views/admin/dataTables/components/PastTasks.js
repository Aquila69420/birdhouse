...
import { Box, Text, Stack, Grid, GridItem, CircularProgress, CircularProgressLabel, Button, useColorModeValue } from "@chakra-ui/react";
...
const PastTasks = () => {
  ...
  return (
    <Box
      ...
      boxShadow="md"
    >
      {/* Main heading for My Validated Tasks */}
